...
```bash
python seedemu/testing/cli.py clean examples/basic/A15_bgp_ipv6_dual_stack/example.yaml
python seedemu/testing/cli.py compile examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
python seedemu/testing/cli.py test examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
```

Docker-heavy runtime checks stay opt-in through the same manifest:

```bash
python seedemu/testing/cli.py build examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
python seedemu/testing/cli.py up examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
python seedemu/testing/cli.py probe examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
python seedemu/testing/cli.py down examples/basic/A15_bgp_ipv6_dual_stack/example.yaml --artifact-dir ci-artifacts/a15
```
