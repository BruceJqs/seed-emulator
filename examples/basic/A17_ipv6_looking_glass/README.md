...
```bash
python seedemu/testing/cli.py clean examples/basic/A17_ipv6_looking_glass/example.yaml
python seedemu/testing/cli.py compile examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
python seedemu/testing/cli.py test examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
```

Docker-heavy runtime checks stay opt-in through the same manifest:

```bash
python seedemu/testing/cli.py build examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
python seedemu/testing/cli.py up examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
python seedemu/testing/cli.py probe examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
python seedemu/testing/cli.py down examples/basic/A17_ipv6_looking_glass/example.yaml --artifact-dir ci-artifacts/a17
```
