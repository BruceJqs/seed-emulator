...
```bash
python seedemu/testing/cli.py clean examples/basic/A16_exabgp_ipv6_control_plane/example.yaml
python seedemu/testing/cli.py compile examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
python seedemu/testing/cli.py test examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
```

Docker-heavy runtime checks stay opt-in through the same manifest:

```bash
python seedemu/testing/cli.py build examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
python seedemu/testing/cli.py up examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
python seedemu/testing/cli.py probe examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
python seedemu/testing/cli.py down examples/basic/A16_exabgp_ipv6_control_plane/example.yaml --artifact-dir ci-artifacts/a16
```
